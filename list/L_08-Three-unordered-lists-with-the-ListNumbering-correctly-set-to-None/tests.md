...
### Procedures
 ...
 1. Check that the [substructures](https://www.pdfa.org/glossary-of-accessibility-terminology-in-pdf/#substructure) of all **L** tags are [semantically appropriate](https://pdfa.org/glossary-of-accessibility-terminology-in-pdf/#Semantically_appropriate) (**LI**, **Lbl**, **LBody**). 
 ...
 1. For those list items that include nested lists, check that the nested list's **L** tag is placed inside the **LBody** of its containing list item. 
