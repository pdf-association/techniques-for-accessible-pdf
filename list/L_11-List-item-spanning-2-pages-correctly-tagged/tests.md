...
### Procedures
 ...
 1. Check that a list item that contains physically separated content (e.g., content that appears on two or more pages or columns) is tagged in a single **LBody** tag.
